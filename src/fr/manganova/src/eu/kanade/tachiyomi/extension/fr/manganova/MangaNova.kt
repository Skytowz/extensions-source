...
class MangaNova : ParsedHttpSource() {
    ...
    override fun popularMangaSelector() = "a.ranking"

    override fun popularMangaFromElement(element: Element): SManga = SManga.create().apply {
        title = element.select("div.ranking_info > div.ranking_title").text().trim()
        setUrlWithoutDomain(element.select("a").attr("href"))
        thumbnail_url = element.select("div.ranking_info > img").attr("src")
    }
    ...
    override fun latestUpdatesSelector() = ".last_series"

    override fun latestUpdatesFromElement(element: Element): SManga {
        return SManga.create().apply {
            title = element.select(".lr_info > .lri_title").text().trim()
            setUrlWithoutDomain(element.select("a").attr("href"))
